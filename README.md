...
Las variables sirven para guardar datos como números, textos o resultados de operaciones, y así poder usarlos más adelante sin tener que escribirlos de nuevo.

También ayudan a que el programa sea más claro, ordenado y fácil de entender, porque cada valor tiene un nombre que indica para qué se usa.
